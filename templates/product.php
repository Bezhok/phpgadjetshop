<?php require_once('base_header.php'); ?> <!-- header -->
    ...
    <article>
        ...
        <section class="product_main_description">
            <section class="product_md_image"><img src="{{ product.main_image.url }}" alt="{{ product.title }}" ></section>
            <section>         <b>Производитель:</b> {{ product.manufacturer.name }}</section>
            <section class="product_md_description">{{ product.description }}</section>
        </section>
                    ...
                    {% for img in product.images_list %}
                        {% if img %}
                            <li class="block block_product">
                                <section class="gray_block"></section><img src="{{ img.url }}" class="block_image" />
                        {% endif %}
                    {% endfor %}
                    <li class="block block_product">
